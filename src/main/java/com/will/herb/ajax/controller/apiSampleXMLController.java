...
public class apiSampleXMLController {
	...
	public static final Logger logger = LoggerFactory.getLogger(apiSampleXMLController.class);
	
	@RequestMapping("/ajaxTest/apiSampleApplicationXML.do")
	public void apiSampleApplicationXML() {
		logger.info("apiSampleApplicationXML 페이지 보여주기");
	}
	
	@RequestMapping("/ajaxTest/apiSampleApplicationJSON.do")
	public void apiSampleApplicationJSON() {
		logger.info("apiSampleApplicationJSON 페이지 보여주기");
	}
